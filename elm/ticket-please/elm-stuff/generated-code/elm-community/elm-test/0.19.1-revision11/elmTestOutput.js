...
var $author$project$TicketPleaseSupport$Archived = {$: 'Archived'};
var $author$project$TicketPleaseSupport$Closed = {$: 'Closed'};
var $author$project$TicketPleaseSupport$InProgress = {$: 'InProgress'};
var $author$project$TicketPleaseSupport$New = {$: 'New'};
var $author$project$TicketPleaseSupport$Resolved = {$: 'Resolved'};
var $author$project$TicketPleaseSupport$Ticket = function (a) {
	return {$: 'Ticket', a: a};
};
var $author$project$TicketPleaseSupport$User = function (a) {
	return {$: 'User', a: a};
};
var $author$project$TicketPlease$assignTicketTo = F2(
	function (user, _v0) {
		var ticket = _v0.a;
		var status = ticket.status;
		switch (status.$) {
			case 'Archived':
				return $author$project$TicketPleaseSupport$Ticket(ticket);
			case 'New':
				return $author$project$TicketPleaseSupport$Ticket(
					_Utils_update(
						ticket,
						{
							assignedTo: $elm$core$Maybe$Just(user),
							status: $author$project$TicketPleaseSupport$InProgress
						}));
			default:
				return $author$project$TicketPleaseSupport$Ticket(
					_Utils_update(
...
var $author$project$TicketPlease$assignedToDevTeam = function (_v0) {
	var assignedTo = _v0.a.assignedTo;
	_v1$3:
	while (true) {
		if (assignedTo.$ === 'Just') {
			switch (assignedTo.a.a) {
				case 'Alice':
					return true;
				case 'Bob':
					return true;
...
var $author$project$TicketPlease$emptyComment = function (_v0) {
	var comment = _v0.b;
	return $elm$core$String$isEmpty(comment);
};
...
var $author$project$Tests$newTicket = {
	assignedTo: $elm$core$Maybe$Just(
		$author$project$TicketPleaseSupport$User('Bob')),
	comments: _List_fromArray(
		[
			_Utils_Tuple2(
			$author$project$TicketPleaseSupport$User('John'),
			'ping?'),
			_Utils_Tuple2(
			$author$project$TicketPleaseSupport$User('Bob'),
			'pong!')
		]),
	createdBy: _Utils_Tuple2(
		$author$project$TicketPleaseSupport$User('John'),
		1),
	status: $author$project$TicketPleaseSupport$New
};
var $author$project$TicketPlease$numberOfCreatorComments = function (_v0) {
	var createdBy = _v0.a.createdBy;
	var comments = _v0.a.comments;
	var _v1 = createdBy;
	var name = _v1.a;
	return $elm$core$List$length(
		A2(
		...
		[
			...
			_List_fromArray(
				[
					...
					'emptyComment should detect an empty comment',
					function (_v0) {
						return A2(
							$elm_explorations$test$Expect$onFail,
							'Expected the comment to be empty',
							A2(
								$elm_explorations$test$Expect$equal,
								true,
								$author$project$TicketPlease$emptyComment(
									_Utils_Tuple2(
										$author$project$TicketPleaseSupport$User('Alice'),
										''))));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'emptyComment should detect an non-empty comment',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$onFail,
							'Expected the comment to contain something',
							A2(
								$elm_explorations$test$Expect$equal,
								false,
								$author$project$TicketPlease$emptyComment(
					...
					A2(
					$elm_explorations$test$Test$test,
					'emptyComment can be used in a filter',
					function (_v2) {
						return A2(
							...
							A2(
								$elm$core$List$filter,
								A2($elm$core$Basics$composeR, $author$project$TicketPlease$emptyComment, $elm$core$Basics$not),
								_List_fromArray(
									[
										_Utils_Tuple2(
										$author$project$TicketPleaseSupport$User('Alice'),
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'numberOfCreatorComments with no comment',
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							0,
							$author$project$TicketPlease$numberOfCreatorComments(
								$author$project$TicketPleaseSupport$Ticket(
									_Utils_update(
										$author$project$Tests$newTicket,
										{
											comments: _List_Nil,
											createdBy: _Utils_Tuple2(
												$author$project$TicketPleaseSupport$User('John'),
					...
					A2(
					$elm_explorations$test$Test$test,
					'numberOfCreatorComments with no comment from creator',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							0,
					...
					A2(
					$elm_explorations$test$Test$test,
					'numberOfCreatorComments with one comment from creator',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							1,
									...
									_Utils_update(
										$author$project$Tests$newTicket,
										{
											comments: _List_fromArray(
												[
													_Utils_Tuple2(
													$author$project$TicketPleaseSupport$User('Jack'),
					...
					A2(
					$elm_explorations$test$Test$test,
					'numberOfCreatorComments with several comments',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							2,
									...
									_Utils_update(
										$author$project$Tests$newTicket,
										{
											comments: _List_fromArray(
												[
													_Utils_Tuple2(
													$author$project$TicketPleaseSupport$User('Roy'),
													'Hello, IT.'),
													_Utils_Tuple2(
													$author$project$TicketPleaseSupport$User('Steve'),
													'My computer refuses to print anything.'),
													_Utils_Tuple2(
													$author$project$TicketPleaseSupport$User('Roy'),
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'assignedToDevTeam with no one assigned',
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$onFail,
							'Expected unassigned ticket',
							A2(
								$elm_explorations$test$Expect$equal,
								false,
								$author$project$TicketPlease$assignedToDevTeam(
									$author$project$TicketPleaseSupport$Ticket(
										_Utils_update(
											$author$project$Tests$newTicket,
					...
					A2(
					$elm_explorations$test$Test$test,
					'assignedToDevTeam with ticket assigned to non-dev team',
					function (_v8) {
						return A2(
							$elm_explorations$test$Expect$onFail,
							'Expected ticket not assigned to dev team',
							A2(
								$elm_explorations$test$Expect$equal,
								false,
								$author$project$TicketPlease$assignedToDevTeam(
					...
					A2(
					$elm_explorations$test$Test$test,
					'assignedToDevTeam with ticket assigned to Alice from dev team',
					function (_v9) {
						return A2(
							$elm_explorations$test$Expect$onFail,
							'Expected ticket assigned to Alice from dev team',
							A2(
								$elm_explorations$test$Expect$equal,
								true,
								$author$project$TicketPlease$assignedToDevTeam(
					...
					A2(
					$elm_explorations$test$Test$test,
					'assignedToDevTeam with ticket assigned to Bob from dev team',
					function (_v10) {
						return A2(
							$elm_explorations$test$Expect$onFail,
							'Expected ticket assigned to Bob from dev team',
							A2(
								$elm_explorations$test$Expect$equal,
								true,
								$author$project$TicketPlease$assignedToDevTeam(
					...
					A2(
					$elm_explorations$test$Test$test,
					'assignedToDevTeam with ticket assigned to Charlie from dev team',
					function (_v11) {
						return A2(
							$elm_explorations$test$Expect$onFail,
							'Expected ticket assigned to Charlie from dev team',
							A2(
								$elm_explorations$test$Expect$equal,
								true,
								$author$project$TicketPlease$assignedToDevTeam(
									$author$project$TicketPleaseSupport$Ticket(
										_Utils_update(
											...
											{
												assignedTo: $elm$core$Maybe$Just(
													$author$project$TicketPleaseSupport$User('Charlie'))
											})))));
					})
				])),
			A2(
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'assign new, unassigned ticket to Roy',
					function (_v12) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$TicketPleaseSupport$Ticket(
							...
							A2(
								$author$project$TicketPlease$assignTicketTo,
								$author$project$TicketPleaseSupport$User('Roy'),
								$author$project$TicketPleaseSupport$Ticket(
									_Utils_update(
										$author$project$Tests$newTicket,
										{assignedTo: $elm$core$Maybe$Nothing, status: $author$project$TicketPleaseSupport$New}))));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'assign new, assigned ticket to Moss',
					function (_v13) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$TicketPleaseSupport$Ticket(
								_Utils_update(
									...
									{
										assignedTo: $elm$core$Maybe$Just(
											$author$project$TicketPleaseSupport$User('Moss')),
										status: $author$project$TicketPleaseSupport$InProgress
									})),
							A2(
								$author$project$TicketPlease$assignTicketTo,
					...
					A2(
					$elm_explorations$test$Test$test,
					'assign in progress, unassigned ticket to Roy',
					function (_v14) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$TicketPleaseSupport$Ticket(
							...
							A2(
								...
								$author$project$TicketPleaseSupport$Ticket(
									_Utils_update(
										$author$project$Tests$newTicket,
										{assignedTo: $elm$core$Maybe$Nothing, status: $author$project$TicketPleaseSupport$InProgress}))));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'assign in progress, assigned ticket to Moss',
					function (_v15) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$TicketPleaseSupport$Ticket(
					...
					A2(
					$elm_explorations$test$Test$test,
					'assign resolved, unassigned ticket to Roy',
					function (_v16) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$TicketPleaseSupport$Ticket(
								_Utils_update(
									$author$project$Tests$newTicket,
									{
										assignedTo: $elm$core$Maybe$Just(
											$author$project$TicketPleaseSupport$User('Roy')),
										status: $author$project$TicketPleaseSupport$Resolved
									})),
							A2(
								$author$project$TicketPlease$assignTicketTo,
								$author$project$TicketPleaseSupport$User('Roy'),
								$author$project$TicketPleaseSupport$Ticket(
									_Utils_update(
										$author$project$Tests$newTicket,
										{assignedTo: $elm$core$Maybe$Nothing, status: $author$project$TicketPleaseSupport$Resolved}))));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'assign resolved, assigned ticket to Moss',
					function (_v17) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$TicketPleaseSupport$Ticket(
					...
					A2(
					$elm_explorations$test$Test$test,
					'assign closed, unassigned ticket to Roy',
					function (_v18) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$TicketPleaseSupport$Ticket(
								_Utils_update(
									$author$project$Tests$newTicket,
									{
										assignedTo: $elm$core$Maybe$Just(
											$author$project$TicketPleaseSupport$User('Roy')),
										status: $author$project$TicketPleaseSupport$Closed
									})),
							A2(
								$author$project$TicketPlease$assignTicketTo,
								$author$project$TicketPleaseSupport$User('Roy'),
								$author$project$TicketPleaseSupport$Ticket(
									_Utils_update(
										$author$project$Tests$newTicket,
										{assignedTo: $elm$core$Maybe$Nothing, status: $author$project$TicketPleaseSupport$Closed}))));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'assign closed, assigned ticket to Moss',
					function (_v19) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$TicketPleaseSupport$Ticket(
					...
					A2(
					$elm_explorations$test$Test$test,
					'unsuccesfulfy assign archived, unassigned ticket to Roy',
					function (_v20) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$TicketPleaseSupport$Ticket(
								_Utils_update(
									$author$project$Tests$newTicket,
									{assignedTo: $elm$core$Maybe$Nothing, status: $author$project$TicketPleaseSupport$Archived})),
							A2(
								$author$project$TicketPlease$assignTicketTo,
								$author$project$TicketPleaseSupport$User('Roy'),
								$author$project$TicketPleaseSupport$Ticket(
					...
					A2(
					$elm_explorations$test$Test$test,
					'unsuccesfulfy assign archived, assigned ticket to Moss',
					function (_v21) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$TicketPleaseSupport$Ticket(
								_Utils_update(
									$author$project$Tests$newTicket,
									{
										assignedTo: $elm$core$Maybe$Just(
											$author$project$TicketPleaseSupport$User('Alice')),
										status: $author$project$TicketPleaseSupport$Archived
									})),
							A2(
								$author$project$TicketPlease$assignTicketTo,
								$author$project$TicketPleaseSupport$User('Moss'),
...
var pipeFilename = "/tmp/elm_test-387948.sock";
var net = require('net'),
