...
var $author$project$Bandwagoner$rootForTeam = function (team) {
	return _Utils_cmp(team.stats.wins, team.stats.losses) > 0;
};
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/christian/data/source/personal/exercism/elm/bandwagoner/tests/Tests.elm']),
		processes: 12,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 174493192028191
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
...
var pipeFilename = "/tmp/elm_test-68917.sock";
var net = require('net'),
