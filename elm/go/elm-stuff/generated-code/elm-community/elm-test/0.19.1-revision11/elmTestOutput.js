...
var $author$project$Tests$koRule = 'Cannot repeat a previously played board position';
var $author$project$Tests$libertyRule = 'Cannot place a stone with no liberties';
var $author$project$Tests$oneStonePerPointRule = 'You can\'t put a stone on top of another stone';
...
var $author$project$Tests$addWhiteCapturedStone = function (game) {
	return _Utils_update(
		game,
		{whiteCapturedStones: 1});
};
...
var $author$project$GoSupport$Black = {$: 'Black'};
var $author$project$GoSupport$White = {$: 'White'};
var $author$project$GoSupport$changePlayer = function (game) {
	var newPlayer = _Utils_eq(game.player, $author$project$GoSupport$White) ? $author$project$GoSupport$Black : $author$project$GoSupport$White;
	return _Utils_update(
		game,
		{player: newPlayer});
};
var $author$project$Go$applyRules = F5(
	function (game, oneStonePerPointRule, captureRule, libertyRule, koRule) {
		var validation = A2(
		...
		if (validation.$ === 'Err') {
			...
			var g = validation.a;
			return $author$project$GoSupport$changePlayer(
				captureRule(g));
		}
	});
...
var $author$project$Tests$errRule = F2(
	function (msg, _v0) {
		return $elm$core$Result$Err(msg);
	});
var $author$project$Tests$identityRule = function (game) {
	return $elm$core$Result$Ok(game);
};
...
var $author$project$GoSupport$Game = F4(
	function (whiteCapturedStones, blackCapturedStones, player, error) {
		return {blackCapturedStones: blackCapturedStones, error: error, player: player, whiteCapturedStones: whiteCapturedStones};
	});
var $author$project$Tests$vanillaGame = A4($author$project$GoSupport$Game, 0, 0, $author$project$GoSupport$White, '');
				...
				[
					...
					function (_v0) {
						return A2(
							...
							$author$project$GoSupport$changePlayer($author$project$Tests$vanillaGame),
							A5($author$project$Go$applyRules, $author$project$Tests$vanillaGame, $author$project$Tests$identityRule, $elm$core$Basics$identity, $author$project$Tests$identityRule, $author$project$Tests$identityRule));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'should retain the error and player if koRule fails',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_Utils_update(
								$author$project$Tests$vanillaGame,
								{error: $author$project$Tests$koRule}),
							A5(
								$author$project$Go$applyRules,
								$author$project$Tests$vanillaGame,
								$author$project$Tests$identityRule,
								$elm$core$Basics$identity,
								$author$project$Tests$identityRule,
								$author$project$Tests$errRule($author$project$Tests$koRule)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'should retain the error and player if libertyRule fails',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_Utils_update(
								$author$project$Tests$vanillaGame,
								{error: $author$project$Tests$libertyRule}),
							A5(
								$author$project$Go$applyRules,
								$author$project$Tests$vanillaGame,
								$author$project$Tests$identityRule,
								$elm$core$Basics$identity,
								$author$project$Tests$errRule($author$project$Tests$libertyRule),
								$author$project$Tests$identityRule));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'should retain the error and player if oneStonePerPointRule fails',
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_Utils_update(
								$author$project$Tests$vanillaGame,
								{error: $author$project$Tests$oneStonePerPointRule}),
							A5(
								$author$project$Go$applyRules,
								$author$project$Tests$vanillaGame,
								$author$project$Tests$errRule($author$project$Tests$oneStonePerPointRule),
								$elm$core$Basics$identity,
								$author$project$Tests$identityRule,
								$author$project$Tests$identityRule));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'should retain changes from captureRule and change player',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$author$project$GoSupport$changePlayer(
								$author$project$Tests$addWhiteCapturedStone($author$project$Tests$vanillaGame)),
							A5($author$project$Go$applyRules, $author$project$Tests$vanillaGame, $author$project$Tests$identityRule, $author$project$Tests$addWhiteCapturedStone, $author$project$Tests$identityRule, $author$project$Tests$identityRule));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'should discard changes from captureRule if subsequent rule fails',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							_Utils_update(
							...
							A5(
								...
								$author$project$Tests$vanillaGame,
								$author$project$Tests$identityRule,
								$author$project$Tests$addWhiteCapturedStone,
								$author$project$Tests$identityRule,
								$author$project$Tests$errRule($author$project$Tests$koRule)));
					})
				]))
...
var $author$project$Test$Generated$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$Tests$vanillaGame),
					$author$project$Test$Runner$Node$check($author$project$Tests$koRule),
					$author$project$Test$Runner$Node$check($author$project$Tests$libertyRule),
					$author$project$Test$Runner$Node$check($author$project$Tests$oneStonePerPointRule),
...
var pipeFilename = "/tmp/elm_test-94618.sock";
var net = require('net'),
