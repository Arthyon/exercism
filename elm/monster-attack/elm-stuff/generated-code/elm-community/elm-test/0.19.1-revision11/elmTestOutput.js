...
var $author$project$MonsterAttack$attackWithClaw1 = F2(
	function (monsterDamage, strength) {
		return monsterDamage + ('Attacked with claw of strength ' + ($elm$core$Debug$toString(strength) + '.'));
	});
var $author$project$MonsterAttack$attackWithSword1 = F2(
	function (monsterDamage, strength) {
		return monsterDamage + ('Attacked with sword of strength ' + ($elm$core$Debug$toString(strength) + '.'));
	});
var $author$project$MonsterAttack$attack1 = function (monsterDamage) {
	return function (m) {
		return A2($author$project$MonsterAttack$attackWithSword1, m, 5);
	}(
		function (m) {
			return A2($author$project$MonsterAttack$attackWithClaw1, m, 1);
		}(
			function (m) {
				return A2($author$project$MonsterAttack$attackWithClaw1, m, 1);
			}(
				A2($author$project$MonsterAttack$attackWithSword1, monsterDamage, 5))));
};
var $author$project$MonsterAttack$attackWithClaw2 = F2(
	function (strength, monsterDamage) {
		return monsterDamage + ('Attacked with claw of strength ' + ($elm$core$Debug$toString(strength) + '.'));
	});
var $author$project$MonsterAttack$attackWithSword2 = F2(
	function (strength, monsterDamage) {
		return monsterDamage + ('Attacked with sword of strength ' + ($elm$core$Debug$toString(strength) + '.'));
	});
var $author$project$MonsterAttack$attack2 = function (monsterDamage) {
	return A2(
		$author$project$MonsterAttack$attackWithSword2,
		5,
		A2(
			$author$project$MonsterAttack$attackWithClaw2,
			1,
			A2(
				$author$project$MonsterAttack$attackWithClaw2,
				1,
				A2($author$project$MonsterAttack$attackWithSword2, 5, monsterDamage))));
};
var $author$project$MonsterAttack$attack3 = A2(
	$elm$core$Basics$composeR,
	$author$project$MonsterAttack$attackWithSword2(5),
	A2(
		$elm$core$Basics$composeR,
		$author$project$MonsterAttack$attackWithClaw2(1),
		A2(
			$elm$core$Basics$composeR,
			$author$project$MonsterAttack$attackWithClaw2(1),
			$author$project$MonsterAttack$attackWithSword2(5))));
		...
		[
			...
			_List_fromArray(
				[
					...
					'attackWithSword1 should update Monster with desired description',
					function (_v0) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Attacked with sword of strength 2.',
							A2($author$project$MonsterAttack$attackWithSword1, '', 2));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'attackWithClaw1 should update Monster with desired description',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Attacked with claw of strength 3.',
							A2($author$project$MonsterAttack$attackWithClaw1, '', 3));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'attack1 should attack with sword twice and claw twice',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							...
							$author$project$MonsterAttack$attack1(''));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'attackWithSword2 should update Monster with desired description',
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Attacked with sword of strength 2.',
							A2($author$project$MonsterAttack$attackWithSword2, 2, ''));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'attackWithClaw2 should update Monster with desired description',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Attacked with claw of strength 3.',
							A2($author$project$MonsterAttack$attackWithClaw2, 3, ''));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'attack2 should attack with sword twice and claw twice',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Attacked with sword of strength 5.Attacked with claw of strength 1.Attacked with claw of strength 1.Attacked with sword of strength 5.',
							$author$project$MonsterAttack$attack2(''));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'attack3 should attack with sword twice and claw twice',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Attacked with sword of strength 5.Attacked with claw of strength 1.Attacked with claw of strength 1.Attacked with sword of strength 5.',
							$author$project$MonsterAttack$attack3(''));
					})
				]))
		]));
...
var pipeFilename = "/tmp/elm_test-764447.sock";
var net = require('net'),
