...
var $author$project$TopScorers$updateGoalCountForPlayer = F2(
	function (playerName, playerGoalCounts) {
		return A3(
...
var $author$project$TopScorers$aggregateScorers = function (playerNames) {
	return A3($elm$core$List$foldl, $author$project$TopScorers$updateGoalCountForPlayer, $elm$core$Dict$empty, playerNames);
};
...
var $author$project$TopScorers$combineGames = F2(
	function (game1, game2) {
		var onlyOne = F2(
			function (name, count) {
				return A2($elm$core$Dict$insert, name, count);
			});
		var both = F3(
			function (name, leftCount, rightCount) {
				return A2($elm$core$Dict$insert, name, leftCount + rightCount);
			});
		return A6($elm$core$Dict$merge, onlyOne, both, onlyOne, game1, game2, $elm$core$Dict$empty);
	});
...
var $author$project$TopScorers$formatPlayer = F2(
	function (playerName, playerGoalCounts) {
		var goals = A2(
			$elm$core$Maybe$withDefault,
			0,
			A2($elm$core$Dict$get, playerName, playerGoalCounts));
		return playerName + (': ' + $elm$core$String$fromInt(goals));
	});
var $author$project$TopScorers$formatPlayers = function (players) {
	return A2(
		$elm$core$String$join,
		', ',
		A2(
			...
			function (_v0) {
				var p = _v0.a;
				return A2($author$project$TopScorers$formatPlayer, p, players);
			},
...
var $author$project$TopScorers$removeInsignificantPlayers = F2(
	function (goalThreshold, playerGoalCounts) {
		return A2(
			$elm$core$Dict$filter,
			F2(
				function (_v0, goals) {
					return _Utils_cmp(goals, goalThreshold) > -1;
				}),
			playerGoalCounts);
	});
var $author$project$TopScorers$resetPlayerGoalCount = F2(
	function (playerName, playerGoalCounts) {
		return A3($elm$core$Dict$insert, playerName, 0, playerGoalCounts);
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					'aggregateScores should count the number of occurences of a player name',
					function (_v0) {
						return A2(
							...
							$elm$core$Dict$fromList(
								_List_fromArray(
									[
										_Utils_Tuple2('Betty', 2),
										_Utils_Tuple2('Cedd', 1)
									])),
							$author$project$TopScorers$aggregateScorers(
								_List_fromArray(
									['Betty', 'Cedd', 'Betty'])));
					})
				])),
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'removeInsignificantPlayers should remove players that have scored less goals than the threshold',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Dict$fromList(
							...
							A2(
								$author$project$TopScorers$removeInsignificantPlayers,
								2,
								$elm$core$Dict$fromList(
									_List_fromArray(
										[
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'resetPlayerGoalCount should set the goalCount to zero for the player',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Dict$fromList(
								_List_fromArray(
									[
										_Utils_Tuple2('Betty', 0),
										_Utils_Tuple2('Cedd', 1)
									])),
							A2(
								$author$project$TopScorers$resetPlayerGoalCount,
								'Betty',
								$elm$core$Dict$fromList(
									_List_fromArray(
										[
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'formatPlayer should return the player name and the goal count',
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Betty: 3',
							A2(
								$author$project$TopScorers$formatPlayer,
								'Betty',
								A2($elm$core$Dict$singleton, 'Betty', 3)));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'formatPlayer should return the player name and 0 if the player name is not in the dict',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Betty: 0',
							A2($author$project$TopScorers$formatPlayer, 'Betty', $elm$core$Dict$empty));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'formatPlayers should return the player name and the goal count, ordered by player name',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							'Betty: 2, Cedd: 1',
							$author$project$TopScorers$formatPlayers(
								$elm$core$Dict$fromList(
									_List_fromArray(
										[
											_Utils_Tuple2('Cedd', 1),
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'combineGames should count goals in both games',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Dict$fromList(
								_List_fromArray(
									[
										_Utils_Tuple2('Betty', 4),
										_Utils_Tuple2('Cedd', 1),
										_Utils_Tuple2('Mario', 3)
									])),
							A2(
								$author$project$TopScorers$combineGames,
								$elm$core$Dict$fromList(
									_List_fromArray(
										[
											_Utils_Tuple2('Cedd', 1),
...
var pipeFilename = "/tmp/elm_test-299329.sock";
var net = require('net'),
