...
var $author$project$TreasureChest$TreasureChest = F2(
	function (a, b) {
		return {$: 'TreasureChest', a: a, b: b};
	});
...
var $author$project$TreasureChest$getTreasure = F2(
...
var $author$project$TreasureChest$multiplyTreasure = F2(
	function (multiplier, _v0) {
		var password = _v0.a;
		var treasure = _v0.b;
		var newTreasure = multiplier(treasure);
		return A2($author$project$TreasureChest$TreasureChest, password, newTreasure);
	});
		...
		[
				...
				[
					...
					function (_v0) {
						return A2(
							...
							A2($author$project$TreasureChest$TreasureChest, 'password', 'treasure'),
							A2($author$project$TreasureChest$TreasureChest, 'password', 'treasure'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					...
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2($author$project$TreasureChest$TreasureChest, 'password', 5),
							A2($author$project$TreasureChest$TreasureChest, 'password', 5));
					})
				])),
			A2(
				...
				[
					...
					function (_v2) {
						return A2(
							...
							A2(
								$author$project$TreasureChest$getTreasure,
								'password',
								A2($author$project$TreasureChest$TreasureChest, 'password', 'treasure')));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'Nothing is returned if an incorrect password is used',
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Nothing,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'The multiplied treasure is returned',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							A2(
								$author$project$TreasureChest$TreasureChest,
								'password',
								A2($elm$core$List$repeat, 2, 'treasure')),
							A2(
								$author$project$TreasureChest$multiplyTreasure,
								$elm$core$List$repeat(2),
								A2($author$project$TreasureChest$TreasureChest, 'password', 'treasure')));
					})
				]))
		]));
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/christian/source/personal/exercism/elm/treasure-chest/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 270373385689788
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
...
var pipeFilename = "/tmp/elm_test-45729.sock";
var net = require('net'),
