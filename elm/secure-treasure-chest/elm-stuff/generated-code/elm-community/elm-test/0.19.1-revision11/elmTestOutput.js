...
var $author$project$SecureTreasureChest$Password = function (a) {
	return {$: 'Password', a: a};
};
var $author$project$SecureTreasureChest$createPassword = function (passwordCandidate) {
	return ($elm$core$String$length(passwordCandidate) >= 8) ? $elm$core$Maybe$Just(
		$author$project$SecureTreasureChest$Password(passwordCandidate)) : $elm$core$Maybe$Nothing;
};
var $author$project$SecureTreasureChest$SecureTreasureChest = F2(
	function (a, b) {
		return {$: 'SecureTreasureChest', a: a, b: b};
	});
var $author$project$SecureTreasureChest$createTreasure = F2(
	function (treasure, _v0) {
		var password = _v0.a;
		return A2($author$project$SecureTreasureChest$SecureTreasureChest, password, treasure);
	});
...
var $author$project$SecureTreasureChest$getTreasure = F2(
	function (passwordAttempt, _v0) {
		var password = _v0.a;
		var treasure = _v0.b;
		return _Utils_eq(passwordAttempt, password) ? $elm$core$Maybe$Just(treasure) : $elm$core$Maybe$Nothing;
	});
		...
		[
			...
			_List_fromArray(
				[
					...
					'Password is exposed',
					function (_v0) {
						var identity = function (password) {
							return password;
						};
						return $elm_explorations$test$Expect$pass;
					}),
					A2(
					$elm_explorations$test$Test$test,
					'createPassword returns a Just Password when password meets minimum length',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$all,
							_List_fromArray(
								[
									$elm_explorations$test$Expect$notEqual($elm$core$Maybe$Nothing),
									$elm_explorations$test$Expect$equal(
									$author$project$SecureTreasureChest$createPassword('12345678'))
								]),
							$author$project$SecureTreasureChest$createPassword('12345678'));
					}),
					A2(
					$elm_explorations$test$Test$test,
					'createPassword returns Nothing when password is too short',
					function (_v2) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Nothing,
							$author$project$SecureTreasureChest$createPassword('1234567'));
					})
				])),
			A2(
			$elm_explorations$test$Test$describe,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'SecureTreasureChest is exposed',
					function (_v3) {
						var identity = function (secureTreasureChest) {
							return secureTreasureChest;
						};
						return $elm_explorations$test$Expect$pass;
					})
				])),
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									A2(
										$elm$core$Maybe$map,
										$author$project$SecureTreasureChest$createTreasure('treasure'),
										$author$project$SecureTreasureChest$createPassword('12345678')))
								]),
							A2(
								$elm$core$Maybe$map,
						...
						return A2(
							...
							_List_fromArray(
								[
									...
									A2(
										$elm$core$Maybe$map,
										$author$project$SecureTreasureChest$createTreasure(5),
										$author$project$SecureTreasureChest$createPassword('12345678')))
								]),
							A2(
								$elm$core$Maybe$map,
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'The treasure is returned if the correct password is used',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Just('treasure'),
							A2(
								$elm$core$Maybe$andThen,
								$author$project$SecureTreasureChest$getTreasure('12345678'),
								A2(
									$elm$core$Maybe$map,
									$author$project$SecureTreasureChest$createTreasure('treasure'),
									$author$project$SecureTreasureChest$createPassword('12345678'))));
					...
					A2(
					$elm_explorations$test$Test$test,
					'Nothing is returned if password does not match',
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							$elm$core$Maybe$Nothing,
							A2(
								$elm$core$Maybe$andThen,
								$author$project$SecureTreasureChest$getTreasure('wrong-password'),
								A2(
									$elm$core$Maybe$map,
									$author$project$SecureTreasureChest$createTreasure('treasure'),
									$author$project$SecureTreasureChest$createPassword('12345678'))));
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['/home/christian/source/personal/exercism/elm/secure-treasure-chest/tests/Tests.elm']),
		processes: 8,
		report: $author$project$Test$Reporter$Reporter$ConsoleReport($author$project$Console$Text$UseColor),
		runs: 100,
		seed: 153350916066816
	},
	_List_fromArray(
		[
			_Utils_Tuple2(
...
var pipeFilename = "/tmp/elm_test-85058.sock";
var net = require('net'),
