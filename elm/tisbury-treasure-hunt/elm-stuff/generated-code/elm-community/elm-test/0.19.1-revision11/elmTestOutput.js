...
var $author$project$TisburyTreasureHunt$treasureLocationMatchesPlaceLocation = F2(
	function (_v0, _v1) {
		var c1 = _v0.a;
		var i1 = _v0.b;
		var i2 = _v1.a;
		var c2 = _v1.b;
		return _Utils_eq(c1, c2) && _Utils_eq(i1, i2);
	});
var $author$project$TisburyTreasureHunt$countPlaceTreasures = F2(
	function (_v0, treasures) {
		var location = _v0.b;
		return $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (_v1) {
					...
					return A2($author$project$TisburyTreasureHunt$treasureLocationMatchesPlaceLocation, location, coordinates);
				},
				treasures));
	});
...
var $author$project$TisburyTreasureHunt$placeLocationToTreasureLocation = function (_v0) {
	var c = _v0.a;
	var i = _v0.b;
	return _Utils_Tuple2(i, c);
};
var $author$project$TisburyTreasureHunt$specialCaseSwapPossible = F3(
	function (_v0, _v1, _v2) {
		var foundTreasure = _v0.a;
		var place = _v1.a;
		var desiredTreasure = _v2.a;
		var _v3 = _Utils_Tuple3(foundTreasure, place, desiredTreasure);
		_v3$5:
		while (true) {
			switch (_v3.a) {
				case 'Brass Spyglass':
					if (_v3.b === 'Abandoned Lighthouse') {
						return true;
					} else {
						break _v3$5;
					}
				case 'Amethyst Octopus':
					if (_v3.b === 'Stormy Breakwater') {
						switch (_v3.c) {
							case 'Crystal Crab':
								return true;
							case 'Glass Starfish':
				...
				case 'Vintage Pirate Hat':
					if (_v3.b === 'Harbor Managers Office') {
						switch (_v3.c) {
							case 'Model Ship in Large Bottle':
								return true;
							case 'Antique Glass Fishnet Float':
								return true;
							default:
								break _v3$5;
						}
		...
		[
			...
			_List_fromArray(
				[
					...
					'placeLocationToTreasureLocation should convert PlaceLocation to TreasureLocation',
					function (_v0) {
						return A2(
							...
							_Utils_Tuple2(
								1,
								_Utils_chr('C')),
							$author$project$TisburyTreasureHunt$placeLocationToTreasureLocation(
								_Utils_Tuple2(
									_Utils_chr('C'),
									1)));
					})
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'1,F is not at Seaside Cottages',
					function (_v1) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
							A2(
								$author$project$TisburyTreasureHunt$treasureLocationMatchesPlaceLocation,
								_Utils_Tuple2(
									_Utils_chr('C'),
									1),
								_Utils_Tuple2(
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'places should know how many treasures are available',
					function (_v3) {
						return A2(
							$elm_explorations$test$Expect$equal,
							2,
							A2(
								$author$project$TisburyTreasureHunt$countPlaceTreasures,
								_Utils_Tuple2(
			...
			_List_fromArray(
				[
					A2(
					$elm_explorations$test$Test$test,
					'can swap Amethyst Octopus for Crystal Crab at Stormy Breakwater',
					function (_v4) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
							A3(
								$author$project$TisburyTreasureHunt$specialCaseSwapPossible,
								_Utils_Tuple2(
									'Amethyst Octopus',
									_Utils_Tuple2(
										1,
					...
					A2(
					$elm_explorations$test$Test$test,
					'can swap Amethyst Octopus for Glass Starfish at Stormy Breakwater',
					function (_v5) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
					...
					A2(
					$elm_explorations$test$Test$test,
					'cannot swap Amethyst Octopus for Angry Monkey Figurine at Stormy Breakwater',
					function (_v6) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
					...
					A2(
					$elm_explorations$test$Test$test,
					'can swap Vintage Pirate Hat for Model Ship in Large Bottle at Harbor Managers Office',
					function (_v7) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
					...
					A2(
					$elm_explorations$test$Test$test,
					'can swap Vintage Pirate Hat for Antique Glass Fishnet Float at Harbor Managers Office',
					function (_v8) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
					...
					A2(
					$elm_explorations$test$Test$test,
					'cannot swap Vintage Pirate Hat for Carved Wooden Elephant at Harbor Managers Office',
					function (_v9) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
					...
					A2(
					$elm_explorations$test$Test$test,
					'can swap Brass Spyglass for Robot Parrot at Abandoned Lighthouse',
					function (_v10) {
						return A2(
							$elm_explorations$test$Expect$equal,
							true,
					...
					A2(
					$elm_explorations$test$Test$test,
					'cannot swap Vintage Pirate Hat for Model Ship in Large Bottle at Old Schooner',
					function (_v11) {
						return A2(
							$elm_explorations$test$Expect$equal,
							false,
...
var pipeFilename = "/tmp/elm_test-328521.sock";
var net = require('net'),
