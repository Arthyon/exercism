...
var $author$project$MariosMarvellousLasagna$remainingTimeInMinutes = F2(
	function (layers, timeSinceStart) {
		var preparationTimeInMinutes = layers * 2;
		var expectedMinutesInOven = 40;
		return (expectedMinutesInOven + preparationTimeInMinutes) - timeSinceStart;
	});
...
var pipeFilename = "/tmp/elm_test-226686.sock";
var net = require('net'),
